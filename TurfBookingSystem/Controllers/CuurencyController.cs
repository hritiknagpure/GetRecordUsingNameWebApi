...
        [HttpGet("{id:int}")]
    ...
    {
      var currency =
          _turfBooking.Currencies.FirstOrDefault(c => c.currencyId == id);
...
        [HttpGet("GetByName/{Mypropertyname}")]
    ...
    {
      var currency = _turfBooking
                         .Currencies

                         .FirstOrDefault(c => c.Mypropertyname.ToLower() ==
                                              Mypropertyname.ToLower());
...
        [HttpPost]
...

    {
      ...
      return CreatedAtAction(nameof(GetCurrencyById),
                             new { id = currency.currencyId }, currency);
    }
...
        [HttpPut("{id}")]
    ...
    public IActionResult UpdateCurrency(int id,
                                        [FromBody] Currency updatedCurrency)
...
            existingCurrency.Mypropertyname = updatedCurrency.Mypropertyname;
    ...
           
      ...
      var currency = _turfBooking.Currencies.FirstOrDefault(
          c => c.Mypropertyname.ToLower() == Mypropertyname.ToLower());
    ...
    public IActionResult DeleteCurrency(int id) {
      var currency =
          _turfBooking.Currencies.Find(id);  // Use Find for efficiency
